...
// 	    string(107) "D:\PHPWAMP_IN1\PHPWAMP_IN1\phpwamp\server\Nginx-PHPWNMP\htdocs\shopping\photos\localhost:8080/goods/201806/"
// 	    string(9) "sf_upfile"
		...
		//设置生成缩略图图片的大小
		$dir = basename(dirname($filedir)); //goods
		$tw_s=260;
		$th_s=260;
		$tw_b=600;
		$th_b=600;
