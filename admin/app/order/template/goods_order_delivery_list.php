...
$os = $thisurl.'?type=list&tt=delivery&status=222&desc=order_id';
...
$own = $thisurl.'?type=list&tt=delivery&status=222&desc=delivery_name';
// $dt = $thisurl.'?type=list&tt=delivery&status=222&desc=add_time';
$dt = $thisurl.'?type=list&tt=delivery&status=222&desc=TIMESTAMP';
}else{
$oi = $thisurl.'?type=list&tt=delivery&status=222&asc=order_id';
// $os = $thisurl.'?type=list&tt=delivery&status=222&asc=order_sn';
$os = $thisurl.'?type=list&tt=delivery&status=222&asc=order_id';
...
$own = $thisurl.'?type=list&tt=delivery&status=222&asc=delivery_name';
// $dt = $thisurl.'?type=list&tt=delivery&status=222&asc=add_time';
$dt = $thisurl.'?type=list&tt=delivery&status=222&asc=TIMESTAMP';
}
?>
...
<div class="contentbox">
    ...
    <tr>
	   ...
	   <th><a href="<?php echo $tprice;?>">礼物</a></th>
	   <th>订单状态</th>
	   <th>物流</th>
	   <th>操作</th>
	</tr>
	...
	<td><?php echo $row['state'] == 1 ? "已发货" : "未发货";?></td>
	<td>
  ...
  //批量删除
   ...
   $('.delorder').click(function(){
	...
	$('.order_search').click(function(){
		...
		location.href='<?php echo $thisurl;?>?type=list&time1='+time1+'&time2='+time2+'&tt=delivery&status=222&order_id='+o_sn+'&delivery_name='+own;
	});
