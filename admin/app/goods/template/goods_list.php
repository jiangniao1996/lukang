...
if(isset($_GET['asc'])){
$cate = $thisurl.'?type=goods_list&desc=tb1.gift_id';
// $goods_name = $thisurl.'?type=goods_list&desc=tb1.gift_id';
$price = $thisurl.'?type=goods_list&desc=tb1.gift_value';
$vipprice = $thisurl.'?type=goods_list&desc=tb1.gift_coin';
// $is_on_sale = $thisurl.'?type=goods_list&desc=tb1.is_on_sale';
$addtime = $thisurl.'?type=goods_list&desc=tb1.TIMESTAMP';
}else{
$cate = $thisurl.'?type=goods_list&asc=tb1.gift_id';
// $goods_name = $thisurl.'?type=goods_list&asc=tb1.gift_id';
$price = $thisurl.'?type=goods_list&asc=tb1.gift_value';
$vipprice = $thisurl.'?type=goods_list&asc=tb1.gift_coin';
// $is_on_sale = $thisurl.'?type=goods_list&asc=tb1.is_on_sale';
$addtime = $thisurl.'?type=goods_list&asc=tb1.TIMESTAMP';
}
?>
...
<!-- 		 </select> -->
    ...
    <tr>
	   ...
	   <th><a href="<?php echo $cate;?>">礼物名称</a></th>
	   <th>商品图</th>
	   <th style="width:225px;"><a href="<?php echo $goods_name;?>">提供商家</a></th>
	   <th><a href="<?php echo $price;?>">礼物价值</a></th>
	   <th><a href="<?php echo $vipprice;?>">礼物价值礼物币</a></th>
	   <th>礼物库存</th>
<!--	    <th><a href="<?php echo $vipprice;?>">实际价格</a></th>-->
...
<!-- 	   <th>排序</th> -->
	...
	?>
	<tr>
	<td><input type="checkbox" name="quanxuan" value="<?php echo $row['gift_id'];?>" class="gids"/></td>
	<td><?php echo $row['gift_name'];?></td>
	<td><a target="_blank" href="<?php echo $row['url'];?>"><img src="<?php echo !empty($row['image_url']) ? SITE_URL.$row['image_url'] : $this->img('no_picture.gif');?>" width="60"/></a></td>
	<td><?php echo $row['business_name'];?></td>
	<td><span><?php echo $row['gift_value'];?></span></td>
	<td><span><?php echo $row['gift_coin'];?></span></td>
	<td><span><?php echo $row['gift_stock']?></span></td>
...
<!--  <td><?php echo !empty($row['add_time']) ? date('Y-m-d',$row['add_time']) : "无知";?></td>
  <td><span class="vieworder" id="<?php echo $row['goods_id'];?>" lang="sort_order"><?php echo $row['sort_order'];?></span></td>-->
	<td>
	<a href="goods.php?type=goods_info&id=<?php echo $row['gift_id'];?>" title="编辑"><img src="<?php echo $this->img('icon_edit.gif');?>" title="编辑"/></a>&nbsp;
	<img src="<?php echo $this->img('icon_drop.gif');?>" title="删除" alt="删除" id="<?php echo $row['gift_id'];?>" class="delgoodsid"/>
	</td>
	</tr>
	<?php
	 } ?>
...
// 		is_goods = $('select[name="is_goods_attr"]').val();
		...
		bid = $('select[name="business_id"]').val();;
		
		keys = $('input[name="keyword"]').val();
		
		location.href='<?php echo $thisurl;?>?type=goods_list&business_id='+bid+'&keyword='+keys;
	});
